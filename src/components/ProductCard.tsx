    ...
    <div className="bg-card rounded-lg border p-3 sm:p-4 hover:shadow-md transition-transform transform hover:-translate-y-1 flex flex-col justify-between aspect-square">
      ...
      <div className="mt-3 flex flex-col items-center text-center space-y-2">
        ...
        <Button
          ...
          variant="outline"
          className="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 bg-primary text-primary-foreground hover:bg-primary/90 h-11 rounded-md px-8 flex-1"
          size="sm"
        >
          Add to Cart
        </Button>
